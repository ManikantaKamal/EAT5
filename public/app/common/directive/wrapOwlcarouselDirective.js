'use strict';
reachApp.directive('wrapOwlcarousel', function ($timeout, $rootScope) {
    return {
        restrict: 'E',
        link: function (scope, element, attrs) {
            ...
            $timeout(function () {
                ...
                element.find('.owl-controls').find('.owl-buttons').find('.owl-prev').css('top', 30);
                element.find('.owl-controls').find('.owl-buttons').find('.owl-next').css('top', 30);
