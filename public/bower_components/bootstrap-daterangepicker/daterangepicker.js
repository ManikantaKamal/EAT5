    ...
    DateRangePicker.prototype = {
        ...
        updateFromControl: function () {
            ...
            if (this.singleDatePicker || start === null || end === null) {
                //Swathi(23-Jun-15) : If user inputs sth in text box, make the date range as 
                //current date(2015-06-23 - 2015-06-23) instead of (0000-01-01 - 0000-01-01)
                //if (start === null && end === null) {
            ...
            this.startDate = start;
            this.endDate = end;
            //Swathi(23-Jun-15): Commented below line to update today's data for Scope object
